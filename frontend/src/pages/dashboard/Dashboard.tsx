...
const Dashboard: React.FC = () => {
  ...
  const renderRecentNotifications = () => (
    <Grid item xs={12} md={4}>
      <Paper elevation={1} sx={{ p: 0, height: '100%', overflow: 'hidden' }}>
        <Box sx={{ p: 3, pb: 1 }}>
        ...
        {notifLoading ? (
            ...
            {notifications.slice(0, 5).map((notif, idx) => (
              <React.Fragment key={notif.id}>
                <ListItem sx={{ py: 2, px: 3 }}>
                  <ListItemText 
                    primary={<Typography variant="subtitle2" fontWeight={600} color={notif.is_read ? 'text.secondary' : 'text.primary'}>{notif.title}</Typography>}
          ...
          <Box sx={{ p: 3 }}><Alert severity="info">No recent notifications</Alert></Box>
        )}
      </Paper>
    </Grid>
  );
        ...
        <Grid item xs={12} md={8}>
          <Paper elevation={1} sx={{ p: 3, height: '100%' }}>
            ...
            {loading ? (
              ...
              <Alert severity="info">No tasks data available to show.</Alert>
            )}
          </Paper>
        </Grid>
        ...
        <Grid item xs={12} md={4}>
          <Paper elevation={1} sx={{ p: 0, height: '100%', overflow: 'hidden' }}>
            ...
            {loading ? (
              ...
              <Box sx={{ p: 3 }}><Alert severity="info">No recent tasks</Alert></Box>
            )}
          </Paper>
        </Grid>
        ...
        <Grid item xs={12} md={4}>
          <Paper elevation={1} sx={{ p: 0, height: '100%', overflow: 'hidden' }}>
            ...
            {loading ? (
              ...
              <Box sx={{ p: 3 }}><Alert severity="success">No upcoming deadlines! Great job.</Alert></Box>
            )}
          </Paper>
        </Grid>
